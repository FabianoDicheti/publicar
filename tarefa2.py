...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 23 15:49:06 2022

@author: fabianodicheti

BUSCA LOCAL ITERATIVA RAPIDA
...
def perturba (x_atual, y_atual, delta):
    ...
    print('conf00 = ', x_novo, ' ',y_novo )
        
    sorte = np.random.random(1)[0]
    if sorte > 0.5:
        x_novo = x_novo + (sorte*2)
        y_novo = y_novo + (sorte*2)
    else:
        x_novo = x_novo
        y_novo = y_novo
        print('conf = ', x_novo, ' y_novo ',y_novo )
...
while conta < 50:
    for i in range(40):
        ...
        if sol_nova > sol_velha:
            ...
            todas.append(delta1)
        # mantendo o ponto independente do anterior ser o melhor   
